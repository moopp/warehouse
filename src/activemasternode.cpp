...
// Copyright (c) 2017 Empinel / The YDChain Developers
...
//
// Bootup the masternode, look for a 50000 YDC input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in YDChain.conf */
