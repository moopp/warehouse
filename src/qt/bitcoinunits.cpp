...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YDC");
    case mBTC: return QString("mYDC");
    case uBTC: return QString::fromUtf8("μYDC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YDCs");
    case mBTC: return QString("Milli-YDCs (1 / 1,000)");
    case uBTC: return QString("Micro-YDCs (1 / 1,000,000)");
    default: return QString("???");
    }
}
