...
{
    resize(1024, 520);
    setWindowTitle(tr("YDChain") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a YDChain address"));
    ...
    englishAction = new QAction(QIcon(":/icons/english"), QString("&English"), this);
    englishAction->setToolTip(QString("Change to English"));
    englishAction->setCheckable(true);
    tabGroup->addAction(englishAction);

    cnZhAction = new QAction(QIcon(":/icons/chinese"), QString("中文"), this);
    cnZhAction->setToolTip(QString("切换为中文"));
     cnZhAction->setCheckable(true);
     tabGroup->addAction(cnZhAction);

    connect(englishAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(englishAction, SIGNAL(triggered()), this, SLOT(setToEnglish()));

    connect(cnZhAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(cnZhAction, SIGNAL(triggered()), this, SLOT(setToChinese()));
    ...
    aboutAction = new QAction(tr("&About YDChain"), this);
    aboutAction->setToolTip(tr("Show information about YDChain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for YDChain"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("YDChain client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("YDChain client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YDChain network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid YDChain address or malformed URI parameters."));
    }
...
void BitcoinGUI::setToEnglish()
{
    //showNormalIfMinimized(true);
    //QMessageBox::warning(this, tr("更换钱包语言"), QString("hello"));
    QSettings settings;
    settings.setValue("language", "en");

    //OptionsModel *optionMoldel1 = this->clientModel->getOptionsModel();
    //QMessageBox::warning(this, tr("更换钱包语言"), optionMoldel1->getLanguage());
    QMessageBox::warning(this, QString("Warning"), QString("This setting will take effect after restarting DSCoin."), QMessageBox::Ok);
}


void BitcoinGUI::setToChinese()
{
    //QMessageBox::warning(this, tr("更换钱包语言"), tr("chinese!!!"));
    ...
    //OptionsModel *optionMoldel1 = this->clientModel->getOptionsModel();
    //QMessageBox::warning(this, tr("更换钱包语言"), optionMoldel1->getLanguage());
    QMessageBox::warning(this, QString("重要提示"), QString("重启钱包之后生效."), QMessageBox::Ok);
