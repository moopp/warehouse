...
If you want to build YDChain-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a YDChain-Qt executable will be
built by default.
...
2) The release is built with GCC and then "strip YDChaind" to strip the debug
